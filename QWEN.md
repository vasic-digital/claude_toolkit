<!-- QWEN.md — maintained in lockstep with CLAUDE.md / AGENTS.md / GEMINI.md per constitution §11.4.157. Same governance body as CLAUDE.md; edit all four together. -->
# CLAUDE.md
